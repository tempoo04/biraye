...
const I18N_DICT = {
  en: {
    ...
    research_title: "The research behind BirAye",
    research_intro: "BirAye's design rests on two studies — one on the value of Hifz itself, one on the learning science behind its core feature.",
    res_about_label: "About —",
    res_applied_label: "In BirAye —",
    ...
    res1_about: "Found that children who completed Hifz later showed stronger academic achievement — disciplined verbatim memorization trains memory, attention, and persistence.",
    res1_applied: "This is the whole premise: BirAye treats Hifz as serious verbatim training and gives it a retention engine, instead of being just another Quran audio player.",
    ...
    res2_about: "Showed that studying similar items mixed together — instead of one at a time — helps the brain tell them apart, because it forces discrimination between confusable things.",
    res2_applied: "This is the Similar (mutashabihat) tab: near-identical verses are drilled side by side with the differing words highlighted, so you stop confusing them — the #1 cause of Hifz errors.",
  ...
  az: {
    ...
    help_intro: "BirAye Quranı ayə-ayə əzbərləməyə və — daha vacibi — onu unutmamağa kömək edir. Beş bölmə:",
    help_read: "surə seç, hər ayəni dinlə və izləməyə başlamaq üçün “Əzbərlə”yə toxun.",
    help_drill: "bir ayə diapazonunu öz təkrar sayın və sürətinlə döngüyə salaraq beynində möhkəmlət.",
    help_similar: "asanlıqla qarışdırılan, az qala eyni ayələrə bax; fərqli sözlər vurğulanır ki, fərqi öyrənəsən.",
    help_review: "ayələr unutmağına az qalmış xatırlama üçün geri qayıdır; yaddaşın gücləndikcə kömək azalır.",
    ...
    res1_cite: "Nawaz, N. & Jahangir, S. F. (2015). Effects of memorizing Quran by heart (Hifz) on later academic achievement. Journal of Islamic Studies and Culture, 3(1), 58–64.",
    res1_about: "Hifzi tamamlayan uşaqların sonradan daha güclü akademik nailiyyət göstərdiyini tapdı — intizamlı sözbəsöz əzbərləmə yaddaşı, diqqəti və səbri inkişaf etdirir.",
    res1_applied: "Bütün ideya budur: BirAye Hifzi ciddi sözbəsöz təlim kimi qəbul edir və ona saxlama mühərriki verir — sadəcə növbəti Quran audio pleyeri olmaq əvəzinə.",
    res2_cite: "Birnbaum, M. S., Kornell, N., Bjork, E. L. & Bjork, R. A. (2013). Why interleaving enhances inductive learning: The roles of discrimination and retrieval. Memory & Cognition, 41(3), 392–402.",
    res2_about: "Oxşar elementləri bir-bir əvəzinə qarışıq öyrənməyin beynə onları fərqləndirməyə kömək etdiyini göstərdi, çünki qarışdırıla bilən şeylər arasında fərqləndirməyə məcbur edir.",
